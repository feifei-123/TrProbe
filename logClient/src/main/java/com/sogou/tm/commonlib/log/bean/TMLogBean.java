package com.sogou.tm.commonlib.log.bean;
...
public class TMLogBean implements Parcelable {
    ...
    public TMLogBean(int type, int lv, String key, String tag, String m) {
        this.type = type;
        this.leve = lv;
        this.key = key;
        this.tag = tag;
    ...
    public TMLogBean(int type, int lv, String key, String tag, String m, ThrowableBean bean) {
        this.type = type;
        this.leve = lv;
        this.key = key;
        this.tag = tag;
    ...
    public static final Creator<TMLogBean> CREATOR = new Creator<TMLogBean>() {
        @Override
        public TMLogBean createFromParcel(Parcel source) {
            return new TMLogBean(source);
        }

        @Override
        public TMLogBean[] newArray(int size) {
            return new TMLogBean[size];
        }
    };
